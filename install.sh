...
files="bashrc bash_profile bash_aliases bash_prompt vimrc vim config pryrc psqlrc zshrc zsh_aliases tmux.conf"    # list of files/folders to symlink in homedir
